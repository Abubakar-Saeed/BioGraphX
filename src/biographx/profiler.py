...
from src.biographx.biophysics import BioPhysicsStrategy  # Assuming relative import
...
class MotifProfiler:
    ...
    # -------------------------------------------------------------------------
    def extract_knowledge_profiles(self, sequence: str, hybrid_scores: Dict[str, float]) -> np.ndarray:
        """
