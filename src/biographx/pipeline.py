...
from src.biographx.preprocessor import SequencePreprocessor
from src.biographx.profiler import MotifProfiler
from src.biographx.graph_engine import GraphEngine
from src.biographx.frustration_analyzer import FrustrationAnalyzer
from src.biographx.utils.feature_names import COMPLETE_FEATURE_NAMES
import numpy as np
import gc
import csv
import pandas as pd
...
class BioGraphXPipeline:
    ...
    def extract_full_features(self, sequence: str) -> np.ndarray:
        ...
        5. Generate subcellular localization knowledge profiles
        ...
        # -----------------------------------------------------------------
        # Step 5: Localization Knowledge Profiles
        # -----------------------------------------------------------------
        # Generate motif-based and interaction-based localization evidence
        profile_features = self.motif_profiler.extract_knowledge_profiles(
        ...
        all_features = np.concatenate([
            ...
            profile_features,  # 20 dimensions
